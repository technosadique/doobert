...
class PagelyCacheControl
{
    ...
    public function __construct()
    {
        ...
        if (defined('PAGELY_CACHE_DISABLE_ALL'))
        {
            $this->config->all_caching_disabled = PAGELY_CACHE_DISABLE_ALL;
            $this->config->all_caching_disabled_forced = true;
        }
    ...
    public function configDefaults()
    {
        ...
        $config->all_caching_disabled_forced = false;
