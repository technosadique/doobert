	...
	function widget( $args, $instance ) {
		...
		<div class="wrap">
			...
			<div class="facebook">
				...
				<div class="bottom">				
					<div class="count"><a target="_blank" href="<?php echo get_option('wellthemes_facebook_link'); ?>"><?php echo number_format( get_option('wellthemes_facebook_followers')); ?></a></div>
			...
			<div class="twitter">
				...
				<div class="bottom">
					<div class="count"><a target="_blank" href="http://twitter.com/<?php echo $wt_twitter_id; ?>"><?php echo number_format( get_option('wellthemes_twitter_followers') ); ?></a></div>
