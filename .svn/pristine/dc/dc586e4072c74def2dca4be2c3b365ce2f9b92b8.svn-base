/**
 * mapSvg 5.5.15 - Interactive Map Plugin
 *
...
var mapSVG = function(elem, options){
    ...
    this.methods = {
        ...
        panStart : function (e){
                ...
                if(e.target.id == 'btnZoomIn' || e.target.id == 'btnZoomOut' || (_data.options.editMode && $(e.target).is('image')))
                    return false;
       ...
       regionAdd : function (_item){
            ...
            if(_item.default_attr['fill'] && _item.default_attr['fill'] != 'none' && _data.options.colors.base)
        ...
        markAddClickHandler : function(e){
            ...
            //console.log(e.layerX, e.offsetX, e.clientX, _data.$map.offset().left);
            //var x = e.offsetX == undefined ? e.layerX : e.offsetX;
            //var y = e.offsetY == undefined ? e.layerY : e.offsetY;
            var x = e.clientX - _data.$map.offset().left + $(window).scrollLeft();
            var y = e.clientY - _data.$map.offset().top + $(window).scrollTop();
            //console.log(e.clientY, e.screenY, _data.$map.offset().top);
